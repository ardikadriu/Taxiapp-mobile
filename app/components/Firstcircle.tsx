...
const Firstcircle = () => {
  return (
    <div className="flex-col flex items-center max-sm:flex max-sm:flex-col max-sm:items-center max-sm:reltaive ">
      <div className="w-[427px] h-[439px] rounded-[439px] bg-[#FFB900] absolute left-[232px] top-[-257px] max-sm:absolute max-sm:left-[232px]"></div>
